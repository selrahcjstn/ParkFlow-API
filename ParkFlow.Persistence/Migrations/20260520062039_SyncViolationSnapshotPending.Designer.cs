...
namespace ParkFlow.Persistence.Migrations
{
    ...
    [Migration("20260520062039_SyncViolationSnapshotPending")]
    partial class SyncViolationSnapshotPending
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParkFlow.Domain.Entities.Violation", b =>
                {
                    ...
                    b.Property<DateTime>("RecordedEntryTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("RecordedExitTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("RecordedOverstayMinutes")
                        .HasColumnType("integer");
